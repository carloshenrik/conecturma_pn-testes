...
class AlunoFacade:
    ...
    def update_aluno_facade(self, id, nome , senha,turma='0',escola='0',rede='0'):
        return self.aluno.update_aluno(update_id=id, nome=nome, senha=senha,vinculo_turma=turma,vinculo_escola=escola,vinculo_rede=rede)
